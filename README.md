...
[![Version](https://img.shields.io/badge/version-5.0.0-blue.svg)](https://github.com/shadowdevnotreal/DISCERN-Protocol)
[![License](https://img.shields.io/badge/license-GPL%20v3.0-green.svg)](LICENSE)
[![Made with Love](https://img.shields.io/badge/made%20with-❤️%20%26%20🕊️-red.svg)](https://github.com/shadowdevnotreal/DISCERN-Protocol)
[![Live Demo](https://img.shields.io/badge/demo-live-brightgreen.svg)](https://discernprotocol.netlify.app/)
[![AI Coach](https://img.shields.io/badge/AI-Coach%20Available-blue.svg)](https://chatgpt.com/g/g-685f7ec1cae4819183b514fdeff27b43-discern-bot-relationship-navigation-coach)
...
```mermaid
flowchart TB
    A[User Enters DISCERN] --> B{Take Assessment}

    B --> C[4-Domain Analysis]
    C --> D[Safety Domain]
    C --> E[Accountability Domain]
    C --> F[Pattern Domain]
    C --> G[Impact Domain]

    D --> H{Pathway Recommendation}
    E --> H
    F --> H
    G --> H

    H -->|Low-Moderate Risk| I[REPAIR Ecosystem]
    H -->|High-Critical Risk| J[LIBERATE Ecosystem]

    I --> K[REPAIR Contract]
    I --> L[REPAIR Progress]
    I --> M[REPAIR Framework]
    I --> N[8 REPAIR Phases]

    J --> O[LIBERATE Contract]
    J --> P[LIBERATE Progress]
    J --> Q[LIBERATE Framework]
    J --> R[6 LIBERATE Phases]
...
|----------|-----|-----------|--------|
| ![HTML5](https://img.shields.io/badge/HTML5-E34F26?style=flat-square&logo=html5&logoColor=white) | ![ChatGPT](https://img.shields.io/badge/ChatGPT-Chatbots-74aa9c?style=flat-square) | ![Chart.js](https://img.shields.io/badge/Chart.js-FF6384?style=flat-square&logo=chart.js&logoColor=white) | ![CSS3](https://img.shields.io/badge/CSS3-1572B6?style=flat-square&logo=css3&logoColor=white) |
| ![JavaScript ES6+](https://img.shields.io/badge/JavaScript-ES6+-F7DF1E?style=flat-square&logo=javascript&logoColor=black) | ![Groq](https://img.shields.io/badge/Groq-LPU-F55036?style=flat-square) | ![localStorage](https://img.shields.io/badge/localStorage-Persistence-4285F4?style=flat-square) | ![Glassmorphism](https://img.shields.io/badge/Glassmorphism-Modern-8A2BE2?style=flat-square) |
...
[![GitHub Stars](https://img.shields.io/github/stars/shadowdevnotreal/DISCERN-Protocol?style=social)](https://github.com/shadowdevnotreal/DISCERN-Protocol/stargazers)
[![GitHub Forks](https://img.shields.io/github/forks/shadowdevnotreal/DISCERN-Protocol?style=social)](https://github.com/shadowdevnotreal/DISCERN-Protocol/network)
